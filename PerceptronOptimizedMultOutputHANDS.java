...
public class PerceptronOptimizedMultOutputHANDS
{
    ...
    */
   public PerceptronOptimizedMultOutputHANDS(int numInputs, int numOutputs, int[] hiddenLayerNodes, double lambda,
   ...
   public static void main(String[] args) throws IOException
   {
      ...
      PerceptronOptimizedMultOutputHANDS testNet = new PerceptronOptimizedMultOutputHANDS(numInputs, numOutputs, hiddenLayerNodes,
      ...
      String targetsFile = "handTargets.in";
